...
public class CalendarioController implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest req, HttpServletResponse res) throws Exception {
     System.out.println("Entra a CalendarioController servlet");
        ...
        cancha= canchaService.obtenerCancha(Integer.parseInt(codCancha));
        System.out.println("Nombre de cancha " + cancha.getDescripcion());
        System.out.println("En fecha " + fecha);
        cancha.setListDias(calendarioService.obtenerDias(fecha));
        cancha.setListCalendario(calendarioService.obtenerCalendario(Integer.parseInt(codCancha), fecha));
