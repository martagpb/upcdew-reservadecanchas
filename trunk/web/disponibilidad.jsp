    ...
    <head>
        ...
        <script LANGUAGE="JavaScript" >
            ...
            function prueba (cadena){
                ...
                document.frmConsulta.action ="calendario.htm?cancha="+cadena+"&txtFecha="+document.frmConsulta.txtFecha.value;
                            ...
                            <tbody>
                                <c:forEach var="canchaDisponible" items="${canchasDisponibles}" >
                                    <c:choose>
                                        ...
                                        <td style="display:none"><input name="txtCodCancha" type="text" class="Texto1"  value="${canchaDisponible.codCancha}" size="11" maxlength="10"/></td>
                                        <td> <a  href="JavaScript:prueba('${canchaDisponible.codCancha}')"> Ver calendario </a></td>
